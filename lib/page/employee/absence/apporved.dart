...
class AprovedAbsenceEmployeePage  extends StatefulWidget {
  AprovedAbsenceEmployeePage({this.type});
  var type;
  @override
  _AprovedAbsenceEmployeePageState createState() => _AprovedAbsenceEmployeePageState();
}

class _AprovedAbsenceEmployeePageState extends State<AprovedAbsenceEmployeePage> {
  var user_id;
  Map _absence;
  bool _loading = true;
  @override
