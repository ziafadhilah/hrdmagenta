...
class PendingAbsenceEmployeePage extends StatefulWidget {
  PendingAbsenceEmployeePage({this.type});

  var type;

  @override
  _PendingAbsenceEmployeePageState createState() => _PendingAbsenceEmployeePageState();
}

class _PendingAbsenceEmployeePageState extends State<PendingAbsenceEmployeePage> {
  var user_id;
