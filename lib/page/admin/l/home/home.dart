...
class _HomeAdminState extends State<HomeAdmin>{
        ...
        children: <Widget>[
          ...
          new Container(
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => TabsAbsenceAdmin()
                ));
    ...
    return Container(
      ...
      child: Container(
        child: Flex(
          ...
          children: <Widget>[
            Expanded(
              child: _isLoading_project?Center(child: CircularProgressIndicator(),): ListView.builder(
    ...
    return Container
      ...
      child: Column(
        children: <Widget>[
          ...
          SizedBox(height: 10,),
          Text("${_employee['data'][index]['first_name']}",
            style: TextStyle(
              color: Colors.white
            ),
          ),
          ...
          Container(
            ...
            child: Flex(
              ...
              Expanded(
                  ...
                  child: Container(
                    child: _isLoading_employee==true?Center(child: CircularProgressIndicator(),):ListView.builder(
                        itemCount: _employee['data'].length,
                        scrollDirection: Axis.horizontal,
                        itemBuilder:(context,index){
                          return _buildemployee(index);
                        }),
  ...
  Future dataProject() async{
    try{
      ...
      http.Response response=await http.get("http://${base_url}/api/events?status=approved");
  ...
  Future<void> sendNotification(String body, String title) async{
    ...
    String serverToken='AAAAd5a4eRw:APA91bGlFuCRH2hAfwDLiUNdFeiYCXcnwyszIj0xwa_RF4IILoZjJiJ3NqbRfab6xI4Wn3DyfvdVMmrhVjUsmAzHRPClh6R5gb3aLEsFpZTm-ZAyDL28BFX6GrIQGnhpcnMfA6wTmdJJ';
